    ...
    return (
        <div className="bg-dark rounded p-4 mb-4">
            ...
            <div className="list-group list-group-flush bg-transparent">
                <Link href={route('user.payment.index')} className="list-group-item list-group-item-action bg-dark text-white border-secondary d-flex justify-content-between align-items-center">
